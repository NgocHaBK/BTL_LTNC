          ...
          <div className="warning_item position-relative">
            ...
            <ul>
              {alerts.lowStock.map((batch, index) => (
                <li key={index}>
                  {batch.medicineId}: Batch {batch.batchNumber} is low on stock.
                </li>
              ))}
            </ul>
          </div>
          <div className="warning_item">
            ...
            <ul>
              {alerts.nearExpiry.map((batch, index) => (
                <li key={index}>
                  {batch.medicineId}: Batch {batch.batchNumber} is near expiry.
                </li>
              ))}
            </ul>
          </div>
      ...
      <div className="container mb-5">
        ...
        <Modal show={modal1Show_} onHide={handleCloseModal1}>
          <Modal.Header closeButton>
            <Modal.Title>Add New Batch to Existing or New Medicine</Modal.Title>
          </Modal.Header>
          <Modal.Body>
