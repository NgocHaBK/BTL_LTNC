        ...
        <div className={Signup_css.main}>
          ...
          <div className={Signup_css.main_signup}>
            <form onSubmit={handleSubmitSignUp}>
              <label htmlFor={Signup_css.chk} aria-hidden="true">
                ĐĂNG KÝ
              </label>
          ...
          <div className={Signup_css.login}>
            <form onSubmit={handleSubmitSignIn}>
              ...
              <div className={Signup_css.signin}>
                ...
                <button type="button" onClick={handleEmployeeClick}>
                  Click here if you are my employee
                </button>
              </div>
            </form>
            <div className={Signup_css.wrapper_}>
              <div className={Signup_css.have_anAccount}>
                Chưa có tài khoản? <span>Đăng kí!</span>
              </div>
              <div className={Signup_css[`forgot-password`]}>
